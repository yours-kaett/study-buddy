    ...
    <body>
        <header>
            <div class="d-flex align-items-center justify-content-between top-0 fixed-top p-2 mx-2">
                <h4 class="d-flex align-items-center justify-content-center fw-bolder mt-2">
                    ...
                    <span class="pb-1">&nbsp;Setup Quiz</span>
                </h4>
                <a href="account.php">
                        ...
                        <form action="../../backend/setup-quiz-sanitize.php" method="POST" class="mb-4 w-100">
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" name="topic_title" placeholder="Type here" class="starters-input w-100 mb-2" required>
                                </div>
                                <div class="col-lg-12">
                                    <label>Direction</label>
                                    <textarea name="direction" class="starters-input w-100" cols="30" rows="3" placeholder="Type here" required></textarea>
                                </div>
                            </div>
                            <hr>
        ...
        <footer>
            <div class="d-flex align-items-center justify-content-between bottom-0 fixed-bottom px-3">
                ...
                <a href="setup-quiz.php" class="d-flex flex-column align-items-center" style="color: #3552a1">
